 ...
 * E.g.
 * <script src="https://cdnjs.cloudflare.com/ajax/libs/stellar-sdk/5.0.4/stellar-sdk.js"></script>
 */
...
[stellarLike, assetPriceOnChange, keybaseUserChanged, createTransaction] = (function() {
    ...
    function createStellarLikeButton() {
        var buttonTemplate = `<a onclick="stellarLike()" class="stellarlikeLink">Stellar Like</a>`;

        var div = document.createElement('div');
        div.className = "stellarlike";
    ...
    function readStellarLikeContent() {
        ...
        var stellarLikeHtml = sourceHtml.match(contentRegex)[1];
        // console.log("stellarLikeHtml:" + stellarLikeHtml);
        var stellarLikeContent = extractContent(stellarLikeHtml);
        console.log("stellarLikeContent: " + stellarLikeContent);
        return stellarLikeContent;
    }

    function extractContent(stellarLikeHtml) {
        var div = document.createElement('div');
        div.innerHTML = stellarLikeHtml;
        var innerText = div.innerText;
        // console.log("innerText:" + innerText);
        var textContent = div.textContent;
        // console.log("textContent:" + textContent);
        var content = innerText || textContent;

        var alphanumeric = diacritic.clean(content).replace(/[\W_]+/g,"");
...
},{"diacritic":2}],2:[function(require,module,exports){
// Diacritics.js
// 
